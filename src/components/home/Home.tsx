  ...
  return (
    <div className='home__container'>
      ...
      <div className="home__description">
        ...
        <article className='home__description__words'>Soulbound allows users to mint a non-transferable token that lives with the wallet forever until burned. This allows wallet owners to specify their Username, Bio, and a Token URI (IPFS link for Profile Picture). Soulbound is compatible with the c0nn3ct3d application. These tokens will not be found on OpenSea or Etherscan. We are currently running on the Rinkeby Test Network. </article>
